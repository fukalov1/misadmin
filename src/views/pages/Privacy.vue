<template>
  <CContainer class="d-flex align-items-center min-vh-100">
    <CRow class="w-100 justify-content-center">
      <CCol md="6">
        <div class="clearfix">
          <h1 class="float-left pt-1">Политика в&nbsp;отношении обработки персональных данных </h1>
          <div id="inputResult">
            <div class="row mb-4">
              <div class="col">
                ...
                <div class="descr">
                  ...
                  данных, предпринимаемые <span class="link mark owner-name-field" id="owner-name-value" data-scroll-to="#owner-name-field">Индивидуальный предприниматель Кузнецов Андрей Сергеевич</span> (далее&nbsp;— Оператор).
                </div>
                <div class="ol">
                  <div class="li">
                  ...
                  <div class="li">
                    ...
                    которую Оператор может получить о&nbsp;посетителях веб-сайта <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://pin.poverkadoma.ru</span>.
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col">
                ...
                <div class="ol">
                  ...
                  <div class="li">
                    ...
                    их&nbsp;доступность в&nbsp;сети интернет по&nbsp;сетевому адресу <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://pin.poverkadoma.ru</span>.
                  </div>
                  <div class="li">
                  ...
                  <div class="li">2.8. Персональные данные&nbsp;— любая информация,
                    ...
                    Пользователю веб-сайта <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://pin.poverkadoma.ru</span>.
                  </div>
                  <div class="li">
                  ...
                  <div class="li">
                    2.10. Пользователь&nbsp;— любой посетитель веб-сайта <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://pin.poverkadoma.ru</span>.
                  </div>
                  <div class="li">
                  ...
                  <div class="li" id="HXt9Cgu5d">
                    <table class="purpose-table">
                      ...
                      <tr>
                        ...
                        <td class="data-field"><ul><li><span class="mark link">электронный адрес</span></li><li><span class="mark link">номера телефонов</span></li></ul></td>
                      </tr>
                      <tr>
              ...
              <div class="col">
                ...
                <div class="ol">
                  ...
                  <div class="li">
                    ...
                    Оператору уведомление на&nbsp;адрес электронной почты Оператора <span class="link mark owner-email-field" data-scroll-to="#owner-email-field">info@poverkadoma.ru</span>
                  ...
                  <div class="li">
                    ...
                    посредством электронной почты на&nbsp;электронный адрес Оператора <span class="link mark owner-email-field" data-scroll-to="#owner-email-field">info@poverkadoma.ru</span>
              ...
              <div class="col">
                ...
                <div class="ol">
                  <div class="li">
                    ...
                    к&nbsp;Оператору с&nbsp;помощью электронной почты <span class="link mark owner-email-field" data-scroll-to="#owner-email-field">info@poverkadoma.ru</span>.
                  </div>
                  <div class="li">
                  ...
                  <div class="li">
                    ...
                    в&nbsp;сети Интернет по&nbsp;адресу <span id="owner-privacy-url-value" class="link mark owner-privacy-url-field" data-scroll-to="#owner-privacy-url-field">https://pin.poverkadoma.ru/privacy</span>.
                  </div>
                </div>
              </div>
            </div>
